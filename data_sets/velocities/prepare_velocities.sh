...
for grid in 16000 8000 4000 2000 1000 500; do
    ...
    cdo -L -f nc4 -z zip_2 -P $NN setctomiss,0 -remap,../grids/g${grid}m.txt,sar_weights_${grid}m.nc -chname,magnitude,velsurf_mag -selvar,magnitude $infile ${outfile}.nc
    python add_coord.py $outfile ../bed_dem/pism_BedMachineBedmapHFAntarctica_v01_g${grid}m.nc mask 2,4 -o ${outfile}_no_shelves.nc
done
